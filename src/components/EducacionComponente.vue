...
const educacion = ref([
  {fecha: '2024', title: 'Trabajo como Desarrollador Salesforce y Mulesoft', descripcion: 'Actualmente me encuentro trabajando como Desarrollador Salesforce en NTT Data', enlace:'https://www.youtube.com/'},
  {fecha: '2022', title: 'Trabajo en Desarrollo de Integraciones Mulesoft', descripcion: 'Trabajé como desarrollador Mulesoft en Globant, donde mi tarea principal era realizar integraciones entre diferentes sistemas.', enlace:'http:www.direccion.com'},
  ...
  {fecha: '2020', title: 'Curso Programación Web FullStack', descripcion: 'Completé un curso en línea sobre fundamentos de programación, donde aprendí el lenguaje Java.', enlace:'http:www.direccion.com'}
]);
</script>
