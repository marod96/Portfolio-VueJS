...
const title = 'Marcos Rodriguez';
const descripcion = 'Salesforce & Mulesoft Developer';
const residencia = 'Mendoza, Argentina';
const presentacion = 'Bienvenido a mi Portfolio. Soy un desarrollador con experiencia en el CRM Salesforce y el software de integraciones Mulesoft.';
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/mrodpal/' },
...
const telefono = '+54 9 261 3440208';
</script>
